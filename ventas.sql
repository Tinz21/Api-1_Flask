...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-11-2021 a las 20:48:19
...
CREATE TABLE `cliente` (
  ...
  `nombre` varchar(100) COLLATE utf8_unicode_nopad_ci NOT NULL,
  `apellido1` varchar(100) COLLATE utf8_unicode_nopad_ci NOT NULL,
  `apellido2` varchar(100) COLLATE utf8_unicode_nopad_ci DEFAULT NULL,
  `ciudad` varchar(100) COLLATE utf8_unicode_nopad_ci DEFAULT NULL,
...
(11, 'Tingun', 'zalabata', 'Muelas', 'valledupar', NULL);
